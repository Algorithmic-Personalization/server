...
const createChannelSourceDefinition_1 = require("./createChannelSourceDefinition");
const isInputType = (record) => {
    if (!(0, createChannelSourceDefinition_1.isInputType)(record)) {
        return false;
    }
...
//# sourceMappingURL=updateChannelSourceDefinition.js.map