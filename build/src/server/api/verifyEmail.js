...
var createVerifyEmailRoute = function (_a) {
    ...
    return function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var log, token, adminRepo, admin, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, adminRepo.save(admin)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    log('Failed to save admin:', err_1);
                    res.status(500).send('Failed to save admin');
                    return [2 /*return*/];
                case 5:
                    res.redirect("/login?message=".concat((0, urlencode_1.encode)('Email verified, please log in!')));
                    return [2 /*return*/];
            }
        });
    }); };
