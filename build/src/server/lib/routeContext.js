...
var makeRouteConnector = function (context) { return function (builder) { return function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var value, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, builder(context)(req)];
            case 1:
                value = _a.sent();
                res.json({
                    kind: 'Success',
